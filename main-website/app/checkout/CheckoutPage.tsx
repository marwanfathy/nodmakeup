                        ...
                        {cart.items.map((item: CartItemPublic) => {
                            ...
                            return (
                               <div className="summary-item" key={item.id}>
                                   <div className="summary-item-image"><img src={imageUrl} alt={item.productName} /></div>
                                   <div className="summary-item-details">
                                       ...
                                       <div className="summary-item-controls">
                                           ...
                                           <button type="button" className="remove-item-btn" onClick={() => removeItem(item.id)}>Remove</button>
                                       </div>
                                   </div>
